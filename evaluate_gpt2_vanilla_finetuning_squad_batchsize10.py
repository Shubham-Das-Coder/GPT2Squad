...
if __name__ == "__main__":
    ...
    with open("results/evaluate_gpt2_vanilla_finetuning_squad_batchsize10.txt", "w", encoding="utf-8") as f:
        original_stdout = sys.stdout
        sys.stdout = Tee(sys.stdout, f)
        try:
            evaluate_model("models/gpt2_vanilla_finetuning_squad_batchsize10/checkpoint-43415")
        finally:
