...
def evaluate_model(model_path="gpt2"):
    ...
    adapter_model_path = "checkpoints/checkpoint-300"
...
if __name__ == "__main__":
    ...
    with open("results/evaluate_gpt2_checkpoint300_squad.txt", "w", encoding="utf-8") as f:
        original_stdout = sys.stdout
        sys.stdout = Tee(sys.stdout, f)
        try:
            evaluate_model("checkpoints/checkpoint-300")
        finally:
